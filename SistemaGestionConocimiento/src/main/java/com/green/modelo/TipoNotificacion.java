...
*/
@Entity
@Table(name = "tipo_notificacion", schema = "public")
public class TipoNotificacion implements java.io.Serializable {
    ...
    public TipoNotificacion(Long idTipoNotificacion, String activo,
        String descripcion, Date fechaCreacion, Date fechaModificacion,
        String nombre, Set<Notificacion> notificacions, Long usuCreador,
        Long usuModificador) {
