...
public class TipoUsuarioView implements Serializable {
    ...
    public void listener_txtId() {
		try {
			...
			entity = (TipoUsuario) businessDelegatorView.findByCriteriaInTipoUsuario(variable, null, null).get(0);
	...
	public String action_create() {
		try {
			...
			if (true) {
				...
				FacesUtils.addInfoMessage("Se guardó exitosamente la TipoUsuario");
		...
		public String action_modify() {
			...
			try {
				...
				if (true) {
					...
					FacesUtils.addInfoMessage("Se actualizó exitosamente la TipoUsuario");
					action_clear();
	...
	public void setData(List<TipoUsuarioDTO> data) {
		this.data = data;
	}
