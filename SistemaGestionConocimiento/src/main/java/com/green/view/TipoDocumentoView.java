...
public class TipoDocumentoView implements Serializable {
    ...
    public void listener_txtId() {
		try {
			...
			entity = (TipoDocumento) businessDelegatorView.findByCriteriaInTipoDocumento(variable, null, null).get(0);
	...
	public String action_create() {
		try {
			...
			if (true) {
				...
				FacesUtils.addInfoMessage("Se guardó exitosamente la TipoDocumento");
		...
		public String action_modify() {
			...
			try {
				...
				if (true) {
					...
					FacesUtils.addInfoMessage("Se actualizó exitosamente la TipoDocumento");
					action_clear();
	...
	public void setData(List<TipoDocumentoDTO> data) {
		this.data = data;
	}
