...
@ManagedBean
@ViewScoped
public class TipoCapsulaView implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(TipoCapsulaView.class);
    ...
    public void listener_txtId() {
		try {
			...
			entity = (TipoCapsula) businessDelegatorView.findByCriteriaInTipoCapsula(variable, null, null).get(0);
	...
	public String action_create() {
		try {
			...
			if (true) {
				...
				businessDelegatorView.saveTipoCapsula(entity);

				data = null;				
				
				FacesUtils.addInfoMessage("Se guardó exitosamente la TipoCapsula");
		...
		public String action_modify() {
			...
			try {
				...
				if (true) {
					...
					businessDelegatorView.updateTipoCapsula(entity);

					data = null;

					FacesUtils.addInfoMessage("Se actualizó exitosamente la TipoCapsula");
					action_clear();
	...
	public List<TipoCapsulaDTO> getData() {
		try {
			if (data == null) {
				data = businessDelegatorView.getDataTipoCapsula();
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void setData(List<TipoCapsulaDTO> data) {
		this.data = data;
	}
