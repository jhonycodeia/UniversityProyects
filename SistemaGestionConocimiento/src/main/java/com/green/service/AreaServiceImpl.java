...
public class AreaServiceImpl implements AreaService {
    ...
    /**
     * Repository injected by Spring that manages Area entities
     *
     */
    @Autowired
    ...
    */
    ...
    public List<Area> getArea() throws Exception {
        ...
        try {
            ...
            log.error("finding all Area failed", e);
...
//            if (getArea(entity.getIdArea()) != null) {
//                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
//            }

            areaRepository.save(entity);
            log.debug("save Area successful");
        } catch (Exception e) {
    ...
    public void deleteArea(Area entity) throws Exception {
        ...
        try {
            usuarios = usuarioRepository.findByProperty("area.idArea",
                    entity.getIdArea());
            ...
            areaRepository.deleteById(entity.getIdArea());
    ...
    public void updateArea(Area entity) throws Exception {
        ...
        try {
            ...
            log.debug("update Area successful");
        } catch (Exception e) {
    ...
    public List<AreaDTO> getDataArea() throws Exception {
        try {
            ...
            for (Area areaTmp : area) {
                AreaDTO areaDTO2 = areaMapper.areaToAreaDTO(areaTmp);
                areaDTO.add(areaDTO2);
            }
    ...
    public Area getArea(Long idArea) throws Exception {
        ...
        try {
            if (areaRepository.findById(idArea).isPresent()) {
                entity = areaRepository.findById(idArea).get();
            }
        } catch (Exception e) {
            log.error("get Area failed", e);
            throw new ZMessManager().new FindingException("Area");
        } finally {
        }
    ...
    public List<Area> findPageArea(String sortColumnName,
        ...
        throws Exception {
        List<Area> entity = null;

        try {
            entity = areaRepository.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Area Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Area> findByCriteria(Object[] variables,
        ...
        try {
            list = areaRepository.findByCriteria(where);
        } catch (Exception e) {
