...
//            }
    ...
    public void deleteTipoUsuario(TipoUsuario entity) throws Exception {
        ...
        try {
            usuarios = usuarioRepository.findByProperty("tipoUsuario.idTipoUsuario",
    ...
    public TipoUsuario getTipoUsuario(Long idTipoUsuario)
        ...
        try {
            if (tipoUsuarioRepository.findById(idTipoUsuario).isPresent()) {
                entity = tipoUsuarioRepository.findById(idTipoUsuario).get();
            }
        } catch (Exception e) {
