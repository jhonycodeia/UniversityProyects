...
import com.green.mapper.ParametroMapper;
...
public class ParametroServiceImpl implements ParametroService {
    ...
    /**
     * Repository injected by Spring that manages Parametro entities
     *
     */
    @Autowired
    ...
    public List<Parametro> getParametro() throws Exception {
        ...
        try {
            list = parametroRepository.findAll();
        } catch (Exception e) {
...
//            }
    ...
    public void deleteParametro(Parametro entity) throws Exception {
        ...
        try {
            parametroRepository.deleteById(entity.getIdParametro());
    ...
    public Parametro getParametro(Long idParametro) throws Exception {
        ...
        try {
            if (parametroRepository.findById(idParametro).isPresent()) {
                entity = parametroRepository.findById(idParametro).get();
            }
        } catch (Exception e) {
    ...
    public List<Parametro> findPageParametro(String sortColumnName,
        ...
        try {
            entity = parametroRepository.findPage(sortColumnName,
    ...
    public Long findTotalNumberParametro() throws Exception {
        ...
        try {
            entity = parametroRepository.count();
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Parametro Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Parametro> findByCriteria(Object[] variables,
        ...
        try {
            list = parametroRepository.findByCriteria(where);
        } catch (Exception e) {
