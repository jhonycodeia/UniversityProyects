...
import com.green.mapper.TipoDocumentoMapper;
...
//            if (getTipoDocumento(entity.getIdTipoDocumento()) != null) {
...
//            }
    ...
    public void deleteTipoDocumento(TipoDocumento entity)
        ...
        try {
            documentos = documentoRepository.findByProperty("tipoDocumento.idTipoDocumento",
    ...
    public TipoDocumento getTipoDocumento(Long idTipoDocumento)
        ...
        try {
            if (tipoDocumentoRepository.findById(idTipoDocumento).isPresent()) {
                entity = tipoDocumentoRepository.findById(idTipoDocumento).get();
            }
        } catch (Exception e) {
