...
import com.green.mapper.CategoriaMapper;
...
public class CategoriaServiceImpl implements CategoriaService {
    ...
    /**
     * Repository injected by Spring that manages Categoria entities
     *
     */
    @Autowired
...
//            if (getCategoria(entity.getIdCategoria()) != null) {
...
//            }
    ...
    public void deleteCategoria(Categoria entity) throws Exception {
        ...
        try {
            capsulas = capsulaRepository.findByProperty("categoria.idCategoria",
            ...
            categoriaRepository.deleteById(entity.getIdCategoria());
    ...
    public Categoria getCategoria(Long idCategoria) throws Exception {
        ...
        try {
            if (categoriaRepository.findById(idCategoria).isPresent()) {
                entity = categoriaRepository.findById(idCategoria).get();
            }
        } catch (Exception e) {
    ...
    public List<Categoria> findPageCategoria(String sortColumnName,
        ...
        try {
            entity = categoriaRepository.findPage(sortColumnName,
    ...
    public Long findTotalNumberCategoria() throws Exception {
        ...
        try {
            entity = categoriaRepository.count();
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Categoria Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Categoria> findByCriteria(Object[] variables,
        ...
        try {
            list = categoriaRepository.findByCriteria(where);
        } catch (Exception e) {
