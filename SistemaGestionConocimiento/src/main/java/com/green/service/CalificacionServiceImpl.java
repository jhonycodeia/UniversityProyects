...
import com.green.mapper.CalificacionMapper;
...
public class CalificacionServiceImpl implements CalificacionService {
    ...
    */
    ...
    public List<Calificacion> getCalificacion() throws Exception {
        log.debug("finding all Calificacion instances");

        List<Calificacion> list = new ArrayList<Calificacion>();

        try {
            list = calificacionRepository.findAll();
        } catch (Exception e) {
            log.error("finding all Calificacion failed", e);
    ...
    public void saveCalificacion(Calificacion entity) throws Exception {
        log.debug("saving Calificacion instance");

        try {
            if (entity == null) {
                throw new ZMessManager().new NullEntityExcepcion("Calificacion");
            }

            validateCalificacion(entity);

//            if (getCalificacion(entity.getIdCalificacion()) != null) {
//                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
//            }

            calificacionRepository.save(entity);
            log.debug("save Calificacion successful");
        } catch (Exception e) {
            log.error("save Calificacion failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public void deleteCalificacion(Calificacion entity)
        throws Exception {
        log.debug("deleting Calificacion instance");

        if (entity == null) {
            throw new ZMessManager().new NullEntityExcepcion("Calificacion");
        }

        if (entity.getIdCalificacion() == null) {
            throw new ZMessManager().new EmptyFieldException("idCalificacion");
        }

        try {
            calificacionRepository.deleteById(entity.getIdCalificacion());
            log.debug("delete Calificacion successful");
        } catch (Exception e) {
            log.error("delete Calificacion failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public void updateCalificacion(Calificacion entity)
        throws Exception {
        log.debug("updating Calificacion instance");
        ...
        try {
            ...
            calificacionRepository.update(entity);

            log.debug("update Calificacion successful");
        } catch (Exception e) {
            log.error("update Calificacion failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public List<CalificacionDTO> getDataCalificacion()
        ...
        try {
            ...
            for (Calificacion calificacionTmp : calificacion) {
                CalificacionDTO calificacionDTO2 = calificacionMapper.calificacionToCalificacionDTO(calificacionTmp);
    ...
    public Calificacion getCalificacion(Long idCalificacion)
        throws Exception {
        log.debug("getting Calificacion instance");

        Calificacion entity = null;

        try {
            if (calificacionRepository.findById(idCalificacion).isPresent()) {
                entity = calificacionRepository.findById(idCalificacion).get();
            }
        } catch (Exception e) {
            log.error("get Calificacion failed", e);
    ...
    public List<Calificacion> findPageCalificacion(String sortColumnName,
        ...
        try {
            entity = calificacionRepository.findPage(sortColumnName,
    ...
    public Long findTotalNumberCalificacion() throws Exception {
        ...
        try {
            entity = calificacionRepository.count();
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Calificacion Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Calificacion> findByCriteria(Object[] variables,
        ...
        try {
            list = calificacionRepository.findByCriteria(where);
        } catch (Exception e) {
