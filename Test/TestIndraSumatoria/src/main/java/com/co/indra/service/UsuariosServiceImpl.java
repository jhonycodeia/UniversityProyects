...
import com.co.indra.mapper.UsuariosMapper;
...
public class UsuariosServiceImpl implements UsuariosService {
    ...
    /**
     * Repository injected by Spring that manages Usuarios entities
     *
     */
    @Autowired
    ...
    */
    ...
    public void saveUsuarios(Usuarios entity) throws Exception {
        ...
        try {
            ...
            if (getUsuarios(entity.getIdUsuario()) != null) {
    ...
    public void deleteUsuarios(Usuarios entity) throws Exception {
        ...
        List<RegistroCalculo> registroCalculos = null;

        try {
            registroCalculos = registroCalculoRepository.findByProperty("usuarios.idUsuario",
                    entity.getIdUsuario());

            if (Utilities.validationsList(registroCalculos) == true) {
    ...
    public void updateUsuarios(Usuarios entity) throws Exception {
        ...
        try {
            ...
            usuariosRepository.update(entity);
    ...
    public Usuarios getUsuarios(Integer idUsuario) throws Exception {
        ...
        try {
            if (usuariosRepository.findById(idUsuario).isPresent()) {
                entity = usuariosRepository.findById(idUsuario).get();
            }
        } catch (Exception e) {
    ...
    public List<Usuarios> findPageUsuarios(String sortColumnName,
        ...
        try {
            entity = usuariosRepository.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
    ...
    public Long findTotalNumberUsuarios() throws Exception {
        ...
        try {
            entity = usuariosRepository.count();
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Usuarios Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Usuarios> findByCriteria(Object[] variables,
        ...
        try {
            list = usuariosRepository.findByCriteria(where);
        } catch (Exception e) {
