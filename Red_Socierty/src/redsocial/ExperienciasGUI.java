...
public class ExperienciasGUI extends JFrame implements MouseListener,MouseMotionListener,ActionListener{
    ...
    JButton btnVerExp; 
    JButton btnRecomendaciones;
    
    RedSocial red;
    RedSocialGUI redSocialGui;
    int x,y;
    
    public ExperienciasGUI(RedSocial red, RedSocialGUI redSocialGui){
        this.red = red;
    ...
    public void crearVentana(){
        ...
        btnRecomendaciones.setBackground(Color.BLACK);
        btnRecomendaciones.setForeground(Color.WHITE);
        btnRecomendaciones.setFont(new Font("Comic Sans MS",Font.PLAIN,14));
        
        panelInferior.setBorder(BorderFactory.createEmptyBorder(0,0,0,10));
        
        String[][] dataExp = null;
        ArrayList<Experiencia> experiencias = red.getAllExperiencias();
        ...
        panelInferior.add(btnRecomendaciones);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == btnVerExp){           
            ...
            new RecomendacionesGUI(red,this);
        }
